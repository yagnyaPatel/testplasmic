...
import sty from "./PlasmicBaseCard.module.css"; // plasmic-import: mnynovl5iEBEgL/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__dv88, {
          [sty.freeBoxlong__dv88Vl8Sm]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__kjUm3, {
            [sty.freeBoxlong__kjUm3Vl8Sm]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__bMrpc)}
                role={"img"}
              />
            ),
